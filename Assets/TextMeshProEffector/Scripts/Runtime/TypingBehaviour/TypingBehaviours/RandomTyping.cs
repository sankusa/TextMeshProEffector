...
namespace TextMeshProEffector {
    public class RandomTypingStatus : TMPE_TypingBehaviourStatus<CharacterTypingStatus> {
    ...
    public class RandomTyping : TMPE_TypingBehaviour<RandomTypingStatus, CharacterTypingStatus> {
        ...
        protected override void UpdateTypingMain(TMPE_TypeWriter typeWriter) {
            ...
            RandomTypingStatus status = _statusDic[typeWriter];
            ...
            while(status.Timer > status.NextTypeInterval) {
                ...
                if(TryType(typeWriter, status.NextTypeIndex) == false) break;
