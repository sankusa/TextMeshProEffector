...
namespace TextMeshProEffector {
    ...
    internal class TMPE_TextPreprocessorForEditor : ITextPreprocessor {
        ...
        private readonly TMPE_FlexibleEffector _effector;
        private readonly TMPE_TextPreprocessor _textPreprocessor;

        public TMPE_TextPreprocessorForEditor(TMPE_FlexibleEffector effector, TMPE_TextPreprocessor textPreprocessor) {
            _effector = effector;
        ...
        string ITextPreprocessor.PreprocessText(string sourcetext) {
            IReadOnlyList<TMPE_BasicEffectContainer> effectContainers = _effector.BasicEffectContainers;
            ...
            _textPreprocessor.ProcessText(_effector, sourcetext);
