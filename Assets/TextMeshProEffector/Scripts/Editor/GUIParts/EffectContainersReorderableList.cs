...
namespace TextMeshProEffector {
    public class EffectContainersReorderableList<T> where T : ScriptableObject {
        private readonly ReorderableList _reorderableList;

        public EffectContainersReorderableList(SerializedProperty effectContainersProp, string label) {
