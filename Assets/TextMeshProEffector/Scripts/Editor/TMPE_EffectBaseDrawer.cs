...
namespace TextMeshProEffector {
    ...
    public class TMPE_EffectBaseDrawer : PropertyDrawer {
        ...
        public static GUIStyle RightLabelStyle {
            get {
                if(_rightLabelStyle == null) _rightLabelStyle = new GUIStyle(EditorStyles.label) {alignment = TextAnchor.MiddleRight};
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label) {
            ...
            // ヘッダ
            {
                ...
                if(string.IsNullOrEmpty(effect.TagName) == false) {
